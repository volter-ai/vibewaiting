 ...
 * refused with `APPROVAL_REQUIRED`. Asked by the Playwright host before each
 * locator action; `browser.script` is trusted with the page instead.
 */
...
export async function guardBrowserAction({ action, locator, value }: PlaywrightAction): Promise<void> {
