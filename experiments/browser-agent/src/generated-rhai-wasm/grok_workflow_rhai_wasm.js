 ...
 * @returns {string}
 */
export function evaluate_json(input_json) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(input_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.evaluate_json(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
 ...
 * @returns {string}
 */
export function search_tools_json(tools_json, query, limit) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        const ret = wasm.search_tools_json(ptr0, len0, ptr1, len1, limit);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('grok_workflow_rhai_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
