/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1d900af30f278b0cf8dcff091e192065)
...
interface __BaseEnv_Env {
	...
	SESSIONS: DurableObjectNamespace<import("./cloudflare/worker").GrokSession>;
	RATE_GATE: DurableObjectNamespace<import("./cloudflare/worker").RateGate>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./cloudflare/worker");
		durableNamespaces: "GrokSession" | "RateGate";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INFERENCE_ENABLED" | "XAI_CLIENT_VERSION" | "XAI_OAUTH_CLIENT_ID">> {}
}
