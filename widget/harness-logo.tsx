// Canonical harness marks, matching VGAI's HarnessLogo source. Paths come from the MIT-licensed
// @lobehub/icons-static-svg collection used by VGAI; keeping them inline preserves this widget's
// single-file/no-network contract.
import type { JSX } from "preact";
import type { SessionActivity } from "./state.js";
...
// The source files all declare 0 0 24 24, but their actual painted bounds differ dramatically
// (Claude is 24×15 while OpenCode is 16×20). These optical viewBoxes crop only source whitespace,
// leaving a comparable 54–63% painted footprint inside the shared circular avatar.
const LOGOS: Record<string, LogoDefinition> = {
  ...
  opencode: {
    viewBox: "2.5 0 19 24",
    Mark: () => <path d="M16 6H8v12h8V6zm4 16H4V2h16v20z" />,
  },
  pi: {
    viewBox: "0 0 24 24",
    Mark: () => (
...
export function HarnessLogo({
  ...
  return (
    <span
      ...
      aria-hidden="true"
    >
      <svg viewBox={logo.viewBox} focusable="false"><Mark /></svg>
